module.exports = {
    ...
    $description[**Artık Birisi Küfür Ederse Mesajı Silinicek!**]
    $color[00FF00]
    $deleteIn[5s]
    ...
    $description[**Artık Birisi Küfür Ederse Mesajı Silinmiyicek**]
    $color[00FF00]
    $deleteIn[5s]
    $footer[Ayarlayan Kişi $username[$authorID];$authorAvatar] $addTimestamp
    ...
    $deleteIn[5s]
    $deletecommand
    $onlyPerms[admin;{title:Üzgünüm Yetkin Yok}{description:**Bu Özelliği Kullanmak İçin Şu Yetkiye Sahip Olmalısınız: \`Yönetici\`**}{color:00FF00}{delete:5s}]
    `
}